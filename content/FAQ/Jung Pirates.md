...
**Q: Can Mother of Pearl use the Unique Effect to replace the opposing model that kills her if all 4 Miyakomo's Echo are in play?**  
A: No.  In all cases the number of models in play using any Profile Card can never exceed the number of Wound Tracks on the card.  This applies to those recruited during Warband construction and those added during play.  
