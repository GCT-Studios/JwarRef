...
> [!Example]
> The Corruption of Virtue Event is used when an opponent uses a Virtue Token.  
> If a Virtue Token is used, during a Melee Exchange to add more Special Ability options, this is designated Hidden Information.  
> By the time the Player discovers the Virtue Token has been spent, the timing window for the trigger has passed and the Event cannot be used.
